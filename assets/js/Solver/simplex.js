...
if (check == -1) { document.theSpreadsheet.expr.value = "Huh?"; document.theSpreadsheet.output.value = "Error el problema no es de programacion lineal" + cr + cr ; okToRoll = false; return(666);}
...
// alert(tempAr[1+i]);
		...
		document.theSpreadsheet.expr.value = "La expresion en " + i + " no es una desigualdad"; 
...
if  (TableauNumber > maxSteps) document.theSpreadsheet.expr.value = "No se encontro una solucion optima"

else if (singular) document.theSpreadsheet.expr.value = "No existe una solucion optima para este problema"

else

	{

	document.theSpreadsheet.expr.value = "Se encontro una solucion optima: " + objectiveName + " = ";
...
var theString = "Tabla #" + TableauNumber + cr;
...
// alert("tableau is set up");
	...
	// Option 2 // preliminary checks
		...
		if ( (accuracydig == "") || (!looksLikeANumber(accuracydig)) ) { document.theSpreadsheet.expr.value = " "; okToRoll = false}
		...
		if (okToRoll)
			...
			if ((thenum < 1) || (thenum > 14)) {document.theSpreadsheet.expr.value = " "; okToRoll = false}
		...
		if (document.theSpreadsheet.input.value == "") {document.theSpreadsheet.expr.value = "Ingresa un problema "; okToRoll = false; }
	...
	// 
		...
		document.theSpreadsheet.expr.value = "Presiona resolver para obtener la solucion";
